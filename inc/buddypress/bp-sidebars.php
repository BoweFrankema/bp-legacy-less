 ...
 *
 * @uses ssbp_Widget_Setter
 * @since 1.0
 */
function ssbp_theme_populate_sidebars() {

	// Homepage Top Right
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'homepage-top-right' ) ) {
		...
		ssbp_Widget_Setter::set_widget( array(
			'id_base'    => 'text',
	...
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'homepage-center-widget' ) ) {
	...
	// Homepage Left
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'homepage-left' ) ) {
	...
	// Homepage Middle
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'homepage-middle' ) ) {
	...
	// Homepage Right
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'homepage-right' ) ) {

		if ( bp_is_active( 'blogs' ) && is_multisite() && ssbp_Widget_Setter::widget_exists( 'ssbp_bp_blogs_recent_posts_widget' ) ) {
			ssbp_Widget_Setter::set_widget( array(
				'id_base'    => 'ssbp_bp_blogs_recent_posts_widget',
	...
	// Blog Sidebar
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'blog-sidebar' ) ) {
	...
	// Page Sidebar
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'page-sidebar' ) ) {
	...
	// Footer Left
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'footer-left' ) ) {
	...
	// Footer Middle
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'footer-middle' ) ) {
	...
	// Footer Right
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'footer-right' ) ) {
	...
	// Activity Sidebar
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'activity-sidebar' ) ) {
	...
	// Activity Sidebar
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'member-sidebar' ) ) {
	...
	// Group Sidebar
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'groups-sidebar' ) ) {
	...
	// Homepage Right
	if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'forums-sidebar' ) ) {
	...
	if ( function_exists( 'bpdw_slug' ) ) {
		...
		// Wiki Sidebar
		if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'wiki-sidebar' ) ) {
		...
		// Wiki Top
		if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'wiki-top' ) ) {
		...
		// Wiki Bottom Left
		if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'wiki-bottom-left' ) ) {
		...
		// Wiki Bottom Right
		if ( ! ssbp_Widget_Setter::is_sidebar_populated( 'wiki-bottom-right' ) ) {
